...
public class Pitching implements Serializable {
	...
	public String toString() {
		...
		sb.append(FORMAT.format(year)).append(",").append(player).append(",").append(FORMAT.format(regularSeasonERA))
				.append(",").append(FORMAT.format(regularSeasonWinLoss)).append(",")
				.append(FORMAT.format(postseasonERA)).append(",").append(FORMAT.format(postSeasonWinLoss));
		return sb.toString();
	}
